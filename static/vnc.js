...
import RFB from './vnc_server/core/rfb.js';
...
function connectedToServer(e) {
    ...
    //document.getElementById('screen_buttons').style.display = "flex";
...
function disconnectedFromServer(e) {
    ...
    //document.getElementById('screen_buttons').style.display = "none";
    document.getElementById('screen_loading').style.display = "block";
    // if (e.detail.clean) {
    //     status("Отключено");
    // } else {
    //
